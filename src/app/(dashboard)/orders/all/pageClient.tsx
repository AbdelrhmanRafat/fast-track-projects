...
import { Eye, Edit, Trash2, ChevronRight, ChevronLeft, Loader2 } from 'lucide-react';
...
export default function AllOrdersClient({ 
  ...
  const actions: TableAction[] = [
    ...
    },
    {
      ...
      // Only allow edit when status is "مراجعة الطلب من الادارة"
      visible: (row) => row.status === 'مراجعة الطلب من الادارة',
    },
    {
      key: 'delete',
  ...
  const handlePageChange = (newPage: number) => {
    setIsLoading(true);
    router.push(`/orders/all?page=${newPage}`);
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <Table<Order>
        ...
        emptyMessage={t('orders.table.noOrders')}
        skeletonRows={10}
        exportable={true}
