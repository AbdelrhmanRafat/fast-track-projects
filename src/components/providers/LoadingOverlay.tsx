  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-background/80 backdrop-blur-sm">
      ...
      <style jsx>{`
        .loader {
          --duration: 3s;
          /* Use global design tokens instead of local static colors.
             Rely on the app's CSS variables (e.g. --primary, --primary-foreground, --card)
             defined in globals.css / design system. */
          width: 200px;
          height: 320px;
          position: relative;
        ...
        .loader:before, .loader:after {
          ...
          right: 32%;
          bottom: -11px;
          /* use card / surface token for mask background so it follows theme */
          background: var(--card, #e8e8e8);
        ...
        .loader .ground div {
          ...
          width: 200px;
          height: 200px;
          /* Use design tokens for primary and its foreground variant so loader follows the dashboard theme */
          background: var(--primary);
          background: linear-gradient(45deg, var(--primary) 0%, var(--primary) 50%, var(--primary-foreground, var(--primary)) 50%, var(--primary-foreground, var(--primary)) 100%);
          transform-style: preserve-3d;
        ...
        .loader .ground div:before, .loader .ground div:after {
          ...
          height: 300px;
          opacity: 0;
       /* fallback to a subtle translucent overlay for the shine; primary rgba helper may not be
         available globally so use a small translucent black to produce a gentle highlight. */
       background: linear-gradient(var(--primary), rgba(0,0,0,0.04));
          position: absolute;
